...
If $\mc{A}$ is a list and $\mc{B} \equiv \mc{A}[i:j]$ with $0\le i < j \le |\mc{A}|$ and  $i>0$ or $j <|\mc{A}|$ then we say that $\mc{B}$ is a proper sublist of $\mc{A}$.
...
\noindent\fbox{\parbox{\textwidth}{ 
\textbf{Free Variables in a Term}
...
\noindent\fbox{\parbox{\textwidth}{
\textbf{Free Variables in Permissive Formulas}
