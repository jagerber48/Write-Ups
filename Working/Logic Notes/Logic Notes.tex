...
String $\mc{B}$ appears in string $\mc{A}$, or is a substring of string $\mc{A}$, iff there are (possibly empty) strings $\mc{C}$ and $\mc{D}$ such that $\mc{A}\equiv \mc{C}\mc{B}\mc{D}$.
...
We define inductively the depth of a Wff $\mc{A}$.
