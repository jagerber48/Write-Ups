...
$v$ is a variable which appears free (but not bound) in $\mc{A}$. $t$ is a closed term.
...
$v$ is a variable which appears free (but not bound) in $\mc{A}$. $t$ is a closed term which does not appear\footnote{The requirement that $t$ does not appear in $\mc{A}$ ensures that all occurrences of $t$ are replaced by $v$ after the quantifier is introduced.} in $\mc{A}$ or any of the lines $X$.
